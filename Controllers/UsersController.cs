...
namespace JanuszMail.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(JanuszMailContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Provider")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Provider")] User user)
        {
            if (id != user.ID)
            {
                return NotFound();
